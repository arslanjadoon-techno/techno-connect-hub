      ...
      <SidebarFooter className="border-t border-sidebar-border">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex w-full items-center gap-2 rounded-md px-2 py-2 text-left transition-colors hover:bg-sidebar-accent">
              <div
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-sm font-semibold text-white uppercase"
              ...
              {!collapsed && (
                <>
                  <div className="min-w-0 flex-1">
                    <div className="truncate text-sm font-medium text-sidebar-foreground">
                      {user.fullName || "Default Admin"}
                    </div>
                    <div className="truncate text-[11px] text-sidebar-foreground/70 font-semibold text-amber-500 dark:text-amber-400">
                      {formattedRole}
                    </div>
                  </div>
                  <ChevronUp className="h-4 w-4 text-sidebar-foreground/70" />
