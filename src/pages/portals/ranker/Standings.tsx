...
export default function StandingsPage() {
  ...
  const renderSortIcon = (field: SortField) => {
    if (sortField !== field || sortOrder === "normal") {
      return (
        <ArrowUpDown className="h-3.5 w-3.5 ml-1 text-muted-foreground/50 group-hover:text-muted-foreground" />
      );
    }
    return sortOrder === "asc" ? (
      <ArrowUp className="h-3.5 w-3.5 ml-1 text-primary font-bold" />
          ...
          <CrudPage<StandingRow>
            ...
            columns={[
...

              {
                key: "accessories",
                header: "Accessories",
                accessor: (r) => renderInteractiveCell("accessories", r.accessories),
              },
              {
                key: "voice",
                header: "Voice",
                accessor: (r) => renderInteractiveCell("voice", r.voice),
              },
              { key: "hsi", header: "HSI", accessor: (r) => renderInteractiveCell("hsi", r.hsi) },
              { key: "bts", header: "BTS", accessor: (r) => renderInteractiveCell("bts", r.bts) },
              {
                key: "upgrades",
                header: "Upgrades",
                accessor: (r) => renderInteractiveCell("upgrades", r.upgrades),
              },
              { key: "mim", header: "MIM", accessor: (r) => renderInteractiveCell("mim", r.mim) },
              {
                key: "retention",
                header: "Retention",
                accessor: (r) => renderInteractiveCell("retention", r.retention),
              },
              {
                key: "total",
                header: "Total",
                accessor: (r) => renderInteractiveCell("total", r.total, true),
              },
            ]}
          />
        </div>
