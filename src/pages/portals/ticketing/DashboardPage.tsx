...
const LeasingPortalDashboard: React.FC = () => {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f8fafc] p-4 font-sans">
      <div className="flex w-full max-w-md flex-col items-center justify-center rounded-3xl bg-white p-8 sm:p-10 text-center shadow-lg shadow-slate-200/50 border border-slate-100">
        
        {/* Purple Icon Container */}
        <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-tr from-purple-600 to-indigo-500 shadow-md shadow-purple-500/20">
          <Construction className="h-7 w-7 text-white" />
        </div>

        {/* Heading */}
        <h1 className="mb-3 text-2xl font-bold tracking-tight text-[#0f172a] sm:text-3xl">
          Ticketing Portal Dashboard
        </h1>

        {/* Subtitle / Description */}
        <p className="text-sm font-normal text-slate-500 sm:text-base leading-relaxed max-w-xs">
...
export default LeasingPortalDashboard;